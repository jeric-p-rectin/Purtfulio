        ...
        <div id="introduction-section" className="flex flex-col h-screen p-5">
            <div className="flex flex-col m-auto">
                <div className="flex flex-row items-center gap-0">
                    <div>
                        <p id="Creative" className="font-abril text-gray-300 text-2xl text-left">CREATIVE</p>
                        <h1 className="font-abril">
                            <span id="Innovator" className="block text-3xl sm:text-5xl text-gray-100">INNOVATOR</span>
                            <span id="Developer" className="block text-3xl sm:text-5xl text-primary">DEVELOPER</span>
                        </h1>
                    </div>
                    <div className="bg-transparent h-[104px] w-[104px] sm:h-[128px] sm:w-[128px]">
                        <ChessKing />
                    </div>
                </div>

                <p id="Introduction-Paragraph" className="font-lato text-sm sm:text-base text-primary my-8 ml-1">
                ...
                <div className="flex flex-row justify-between items-center w-full">
                    <div className="flex flex-row space-x-4">
                        <a
                            ...
                            aria-label="Jeric Rectin on LinkedIn"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="Jeric Rectin on GitHub"
                            className="w-8 h-8 sm:w-10 sm:h-10 hover:opacity-75 transition"
                        >
                            <GitHubLogo />
                        </a>
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="Jeric Rectin on Facebook"
                            className="w-8 h-8 sm:w-10 sm:h-10 hover:opacity-75 transition"
                        >
                            <FacebookLogo />
                        </a>
